...
export class Schema {
  ...
  public static record<K extends z.ZodString, T extends ZodTypeAny>(
    key: K,
    value: T,
  ): z.ZodRecord<K, T> {
  ...
  public static function<A extends AnyZodTuple, R extends ZodTypeAny>(
    args: A,
    returns: R,
  ): ZodFunction<A, R> {
  ...
  public static union<T extends [ZodTypeAny, ZodTypeAny, ...ZodTypeAny[]]>(
    types: T,
  ): z.ZodUnion<T> {
